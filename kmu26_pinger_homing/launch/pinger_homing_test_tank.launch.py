...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("reprobe_s", default_value="12.0"),
        DeclareLaunchArgument("feedback_update_s", default_value="0.5"),
        DeclareLaunchArgument("feedback_window_s", default_value="6.0"),
        DeclareLaunchArgument("feedback_blend", default_value="0.25"),
        DeclareLaunchArgument("approach_dither_command", default_value="0.06"),
        DeclareLaunchArgument("approach_dither_period_s", default_value="0.9"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "reprobe_s": LaunchConfiguration("reprobe_s"),
                "feedback_update_s": LaunchConfiguration("feedback_update_s"),
                "feedback_window_s": LaunchConfiguration("feedback_window_s"),
                "feedback_blend": LaunchConfiguration("feedback_blend"),
                "approach_dither_command": LaunchConfiguration("approach_dither_command"),
                "approach_dither_period_s": LaunchConfiguration("approach_dither_period_s"),
